...
def main():
    ...
    # Save the figure
    output_path = Path(__file__).parent / "paper" / "figures" / "figure1_pass_rates_heatmap.png"
    fig.savefig(output_path, dpi=300, bbox_inches='tight', facecolor='white')
    print(f"\nFigure saved to: {output_path}")

    # Also save a copy in the plots directory
    plots_path = Path(__file__).parent / "plots" / "figures" / "figure1_pass_rates_heatmap.png"
