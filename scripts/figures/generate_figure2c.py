...
def main():
    ...
    # Save the figure
    output_path = Path(__file__).parent.parent.parent / "paper" / "supplementary" / "figure2c_pass_rates_by_customer_type.png"
    ...
    fig.savefig(extra_plots_dir / "figure_S2_pass_rates_by_customer_type.png", dpi=300, bbox_inches='tight', facecolor='white')

    # Save data summary
    pivot = df.pivot_table(values="pass", index="model_label", columns="customer_type", aggfunc="mean") * 100
    data_path = extra_plots_dir / "figure_S2_pass_rates_by_customer_type_data.txt"
    with open(data_path, "w") as f:
        f.write("Figure S2: Pass Rates by Screener and Customer Type (40-profile subset)\n")
        f.write("=" * 70 + "\n\n")
