...
Provides consistent colors, fonts, and styling across all figure scripts.
"""
...
def shorten_model_label_no_time(label: str) -> str:
    """Get shortened model label without time indication."""
    return MODEL_LABELS_NO_TIME.get(label, label)


def save_figure(fig, name: str):
    """Save figure as PNG to paper/figures/."""
